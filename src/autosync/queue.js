'use strict';
/** Canonical AutoSync queue/history owner; behavior-preserving migration of Golden v0.15.17. */
const OWNER='autosync.queue';
function install(coreMod){
  const Core=coreMod?.LeagueAutoSyncCore;if(!Core)return coreMod;
  if(Core.prototype.__ARAM_AUTOSYNC_QUEUE__)return coreMod;
  if(Core.prototype.__ARAM_QUEUE_SPLIT_V01517__){Core.prototype.__ARAM_AUTOSYNC_QUEUE__=true;return coreMod}
  ...
  Core.prototype.__ARAM_AUTOSYNC_QUEUE__=true;
  Core.prototype.__ARAM_QUEUE_SPLIT_V01517__=true;
  coreMod.classifyAramQueue=classify;coreMod.runtimeStandardAram=runtimeStandard;coreMod.runtimeStandardAramV01517=runtimeStandard;
  return coreMod;
}
