...
Current app/update version: **v0.15.42**  
...
- `docs/CHANGELOG_v0.15.42.txt` for the current update
- `docs/AUDIT_v0.15.42.txt` for the current validation scope
