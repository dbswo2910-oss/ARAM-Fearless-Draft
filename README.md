...
Current app/update version: **v0.15.60**  
...
v0.15.50–0.15.60 establish the compact **In-game Coach HUD**, consistent visual item language, and a denser Random Practice pick workflow:
...
See `docs/CHANGELOG_v0.15.50.txt` through `docs/CHANGELOG_v0.15.60.txt`.
