...
Current app/update version: **v0.15.35**  
...
For a completely new Windows PC, use the **v0.15.33 standalone Windows x64 bootstrap EXE**, not the historical v0.15.9 executable. The bootstrap embeds v0.15.33, downloads the official Electron 44.2.0 Windows x64 runtime on first launch if necessary, and the app can then update in-place to the current manifest version (currently v0.15.35).
