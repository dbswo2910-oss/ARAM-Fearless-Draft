...
Current app/update version: **v0.15.33**  
...
For a completely new Windows PC, use the current **v0.15.33 standalone Windows x64 bootstrap EXE**, not the historical v0.15.9 executable. The standalone bootstrap embeds the current app and downloads the official Electron 44.2.0 Windows x64 runtime on first launch if necessary.
