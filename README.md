...
Current app/update version: **v0.15.40**  
...
- `docs/CHANGELOG_v0.15.40.txt` for the current update
- `docs/AUDIT_v0.15.40.txt` for the current validation scope
