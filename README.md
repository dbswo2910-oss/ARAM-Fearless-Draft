...
Current app/update version: **v0.15.45**  
...
- `docs/CHANGELOG_v0.15.45.txt` for the current update
- `docs/AUDIT_v0.15.45.txt` for the current validation scope
