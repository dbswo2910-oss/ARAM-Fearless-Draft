...
Current app/update version: **v0.15.78**  
...
3. `docs/AI_HANDOFF_v0.15.78_ADDENDUM.md` — BLACKBOX evidence-driven user-state fix + independent dual heartbeat watchdog
4. `docs/AI_HANDOFF_v0.15.77_ADDENDUM.md` — renderer blackbox, CDP freeze stack capture, fault-isolated runtime loader
5. `docs/STABILITY_AUDIT_v0.15.77.md` — full freeze-risk audit and remaining instrumented risks
6. `docs/AI_HANDOFF_v0.15.75_ADDENDUM.md` — freeze-log-grounded IN GAME transition isolation + durable stage codes
7. `docs/AI_HANDOFF_v0.15.74_ADDENDUM.md` — remaining item-catalog retry freeze guard + main-process watchdog
8. `docs/AI_HANDOFF_v0.15.73_ADDENDUM.md` — reproduced item-catalog hard-freeze diagnosis and first fix
9. `docs/AI_HANDOFF_v0.15.72_ADDENDUM.md` — Random Practice stability consolidation and UI responsiveness work
10. `docs/AI_HANDOFF_v0.15.71_ADDENDUM.md` — real-game AutoSync transport governor
11. `docs/AI_HANDOFF_v0.15.70_ADDENDUM.md` — Random In-game single-owner runtime
12. `docs/AI_HANDOFF_v0.15.69_ADDENDUM.md` — historical Golden Guard autorun diagnosis
13. `docs/INSTALLED_BASELINE_v0.15.49.md` — verified installed base UI/core
14. `reference/installed-v0.15.49/` — exact installed Random Practice DOM fragments
15. `update/manifest.json` — active update payload and current version

## Current runtime direction

v0.15.50–v0.15.78 establish the compact Random Practice in-game coach, unified current item art, denser pick workflow, event-driven compatibility owners, and Windows responsiveness safeguards. The HUD is considered largely stabilized; new work should improve decision quality rather than restart a broad layout redesign unless explicitly requested.
...
Recommendation, ban, team-score, item, threat, and purchase algorithms are unchanged by v0.15.66–v0.15.78 responsiveness work.

See `docs/CHANGELOG_v0.15.50.txt` through `docs/CHANGELOG_v0.15.78.txt` for release history.
