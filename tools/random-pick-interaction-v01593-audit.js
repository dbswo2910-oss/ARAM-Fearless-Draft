...
ok('manifest version',manifest.version==='0.15.93',manifest.version);
...
ok('manifest delivers package',by.get('package.json')==='update/v0.15.93/package.json',by.get('package.json')||'');
