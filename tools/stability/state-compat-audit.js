...
const report={status:'SUCCESS',stage:'CONTRACT_AND_IDENTITY_GUARDS_READY',active_version:manifest.version,stable_app_identity:pkg.name,state_integrity_source:statePath,state_integrity_policy_version:stateOwner.policy_version||stateOwner.VERSION,research_storage_source:researchPath,research_database:'aram-rating-research-v03',research_checkpoint_key:'checkpoint-v03',destructive_research_delete_sources:destructive,real_windows_reference:C.real_windows_reference,synthetic_indexeddb_fixture:'covered_by_windows_electron_synthetic_job',full_installed_fixture_status:'BLOCKED_UNTIL_COMPLETE_INSTALLED_APP_FIXTURE',surfaces:C.surfaces};
L.write('audit-output/stability/state-compat-report.json',report);
console.log('STATE COMPAT AUDIT: SUCCESS · identities and owner contracts preserved');
