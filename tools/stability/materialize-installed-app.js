...
if(!/^\d+\.\d+\.\d+(?:[-+][0-9A-Za-z.-]+)?$/.test(String(manifest.version||'')))throw new Error(`installed materializer requires a valid manifest version, got ${manifest.version}`);
