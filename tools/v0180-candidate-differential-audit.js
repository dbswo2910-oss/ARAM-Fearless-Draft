...
const report={status:'PASS',baselineSha256:sha(baseline),candidateSha256:sha(candidate),approvedChanges:{version:'0.17.0 -> 0.18.0',legacyAutoSyncRequiresRemoved:4,legacyItemCatalogRequiresRemoved:1,canonicalAutoSyncInstallAdded:1,canonicalItemCatalogAdded:1},unapprovedDrift:false};
