...
// v0.15.68: keep Chromium/GPU compositing enabled by default. Software rendering is diagnostic opt-in only.
...
function validateManifestV015116(m){
...
async function checkAndApplyUpdate(){
  ...
  try{
    ...
    try{
      ...
      try{require('./update-safety-v01579').abortUpdateTransaction({reason:'apply-write-failed'})}catch{}
      throw e;
    }
  ...
  }catch(e){try{require('./update-safety-v01579').abortUpdateTransaction({reason:'update-error'})}catch{};return{status:'error',current:VERSION,latest:VERSION,message:e?.message||String(e)}}finally{rmrf(stage);rmrf(backup);updateBusy=false}
}

// v0.15.69: the installed base index contains a developer Golden Guard that runs 271
// synchronous engine checks 30 ms after init and again on the first Data-tab visit.
// In Electron production this can monopolize the renderer and look like a click-induced freeze.
// Keep the manual "전체 테스트 다시 실행" button intact; only remove automatic execution.
function prepareBaseUiForRuntime(){
  ...
  try{
    ...
    let src=fs.readFileSync(p,'utf8'),next=src;
    if(next.includes(startupOld))next=next.replace(startupOld,startupNew);
    if(next.includes(dataOld))next=next.replace(dataOld,dataNew);
    if(next===src)return false;
    const backup=path.join(__dirname,'index.pre-v01569-auto-regression.bak.html');
    if(!fs.existsSync(backup))fs.copyFileSync(p,backup);
    fs.writeFileSync(p,next,'utf8');
    console.log('[v0.15.69] disabled automatic renderer Golden Guard; manual regression button remains available');
    return true;
  }catch(e){console.error('[v0.15.69] base UI startup guard patch failed',e);return false}
}

function createWindow(){
  prepareBaseUiForRuntime();
  ...
  mainWindow.webContents.on('dom-ready',()=>{
    try{
      const scripts=[
        'runtime-blackbox-v01577.js','runtime-safety-net-v01579.js','runtime-performance-v01568.js','runtime-live-autosync-v01571.js','live-strength-v01513.js','match-lab-favorites-v01514.js','role-grade-v01513.js','role-grade-fairs-v01515.js','match-lab-replay-v01515.js','multi-user-isolation-v01516.js','match-lab-queue-v01517.js','draft-pick-balance-v01517.js','catch-resilience-v01540.js','draft-side-order-v01540.js','builder-champion-pool-v01541.js','draft-live-context-v01542.js','draft-balance-alerts-v01543.js','draft-layout-v01545.js','draft-risk-board-v01546.js','draft-judgment-tabs-v01547.js','random-practice-focus-v01549.js','random-pick-density-v01555.js','random-party-picks-v01558.js','random-party-labels-v01559.js','runtime-random-ingame-v01570.js','random-ingame-coach-v01550.js','random-ingame-ux-v01551.js','random-ingame-ux-v01552.js','random-ingame-shop-v01553.js','random-ingame-shop-polish-v01554.js','random-item-icons-v01556.js','item-icons-global-v01557.js','item-art-runtime-v01566.js','ui-refresh-v01560.js','random-party-label-fix-v01561.js','random-party-pool-labels-v01562.js','runtime-random-practice-v01572.js','item-art-hotfix-v01563.js','item-art-unified-v01564.js','item-art-stable-v01565.js','role-metric-detail-v01518.js','cc-impact-v01525.js','mission-death-fairness-v01529.js','player-profile-v01519.js','live-item-memory-v01520.js','player-profile-data-sticky-v01521.js','role-mastery-drilldown-v01522.js','role-profile-context-v01523.js','role-profile-specialized-v01530.js','profile-ux-v01537.js','in-app-updater-ui-v01523.js','time-power-v01527.js','riot-grade-ui-v01528.js','riot-grade-calibration-history-v01532.js','riot-grade-autosnapshot-v01533.js','community-calibration-v01534.js','brand-header-v01538.js','input-interaction-stability-v01539.js'
      ];
      let chain=require('./runtime-loader-v01579').injectRuntimeStack({mainWindow,scripts,blackbox:require('./freeze-blackbox-v01577'),patchRuntimeSource:require('./runtime-source-stability-v015135').patchRuntimeSource});
      chain.then(()=>mainWindow.webContents.executeJavaScript('Boolean(window.__ARAM_BLACKBOX_V01577__) && Boolean(window.__ARAM_SAFETY_NET_V01579__) && Boolean(window.__ARAM_RUNTIME_PERFORMANCE_V01568__) && Boolean(window.__ARAM_LIVE_AUTOSYNC_RUNTIME_V01571__) && Boolean(window.__ARAM_LIVE_STRENGTH_V01513__) && Boolean(window.__ARAM_MATCH_LAB_FAVORITES_V01514__) && Boolean(window.__ARAM_ROLE_GRADE_V01513__) && Boolean(window.__ARAM_ROLE_GRADE_V01515__) && Boolean(window.__ARAM_MATCH_LAB_REPLAY_V01515__) && Boolean(window.__ARAM_MULTI_USER_ISOLATION_V01516__) && Boolean(window.__ARAM_MATCH_LAB_QUEUE_V01517__) && Boolean(window.__ARAM_DRAFT_BALANCE_V01517__) && Boolean(window.__ARAM_CATCH_RESILIENCE_V01540__) && Boolean(window.__ARAM_DRAFT_SIDE_ORDER_V01540__) && Boolean(window.__ARAM_BUILDER_CHAMPION_POOL_V01541__) && Boolean(window.__ARAM_DRAFT_LIVE_CONTEXT_V01542__) && Boolean(window.__ARAM_DRAFT_BALANCE_ALERTS_V01543__) && Boolean(window.__ARAM_DRAFT_LAYOUT_V01545__) && Boolean(window.__ARAM_DRAFT_RISK_BOARD_V01546__) && Boolean(window.__ARAM_DRAFT_JUDGMENT_TABS_V01547__) && Boolean(window.__ARAM_RANDOM_PRACTICE_FOCUS_V01549__) && Boolean(window.__ARAM_RANDOM_PICK_DENSITY_V01555__) && Boolean(window.__ARAM_RANDOM_PARTY_PICKS_V01558__) && Boolean(window.__ARAM_RUNTIME_PERFORMANCE_V01567__) && Boolean(window.__ARAM_RANDOM_PARTY_LABELS_V01559__) && Boolean(window.__ARAM_RANDOM_INGAME_RUNTIME_V01570__) && Boolean(window.__ARAM_RANDOM_INGAME_COACH_V01550__) && Boolean(window.__ARAM_RANDOM_INGAME_UX_V01551__) && Boolean(window.__ARAM_RANDOM_INGAME_UX_V01552__) && Boolean(window.__ARAM_RANDOM_INGAME_SHOP_V01553__) && Boolean(window.__ARAM_RANDOM_INGAME_SHOP_POLISH_V01554__) && Boolean(window.__ARAM_RANDOM_ITEM_ICONS_V01556__) && Boolean(window.__ARAM_ITEM_ICONS_GLOBAL_V01557__) && Boolean(window.__ARAM_ITEM_ART_RUNTIME_V01566__) && Boolean(window.__ARAM_ITEM_ART_SINGLE_OWNER_V01566__) && Boolean(window.__ARAM_UI_REFRESH_V01560__) && Boolean(window.__ARAM_RANDOM_PARTY_LABEL_FIX_V01561__) && Boolean(window.__ARAM_RANDOM_PARTY_POOL_LABELS_V01562__) && Boolean(window.__ARAM_RANDOM_PRACTICE_RUNTIME_V01572__) && Boolean(window.__ARAM_ITEM_ART_HOTFIX_V01563__) && Boolean(window.__ARAM_ITEM_ART_UNIFIED_V01564__) && Boolean(window.__ARAM_ITEM_ART_STABLE_V01565__) && Boolean(window.__ARAM_ITEM_ART_SINGLE_OWNER_V01565__) && Boolean(window.__ARAM_ROLE_METRIC_DETAIL_V01518__) && Boolean(window.__ARAM_CC_IMPACT_V01525__) && Boolean(window.__ARAM_MISSION_DEATH_FAIRNESS_V01529__) && Boolean(window.__ARAM_PLAYER_PROFILE_V01519__) && Boolean(window.__ARAM_LIVE_ITEM_MEMORY_V01520__) && Boolean(window.__ARAM_PLAYER_PROFILE_DIVERSITY_V01521__) && Boolean(window.__ARAM_ROLE_MASTERY_DRILLDOWN_V01522__) && Boolean(window.__ARAM_ROLE_PROFILE_CONTEXT_V01523__) && Boolean(window.__ARAM_ROLE_PROFILE_SPECIALIZED_V01530__) && Boolean(window.__ARAM_PROFILE_UX_V01537__) && Boolean(window.__ARAM_IN_APP_UPDATER_UI_V01523__) && Boolean(window.__ARAM_TIME_POWER_V01527__) && Boolean(window.__ARAM_RIOT_GRADE_V01528__) && Boolean(window.__ARAM_RIOT_GRADE_CALIBRATION_HISTORY_V01532__) && Boolean(window.__ARAM_RIOT_GRADE_AUTOSNAPSHOT_V01533__) && Boolean(window.__ARAM_COMMUNITY_CALIBRATION_V01534__) && Boolean(window.__ARAM_BRAND_HEADER_V01538__) && Boolean(window.__ARAM_INPUT_INTERACTION_STABILITY_V01539__)',false))
        .then(ok=>{if(!ok)console.error('[v0.16.3] runtime patch marker missing')})
        .catch(e=>console.error('[v0.16.3] runtime patch inject failed',e));
    }catch(e){console.error('[v0.16.3] runtime patch read failed',e)}
  });
  // v0.15.68: native move/resize must not run work on every Windows WM_MOVE/WM_SIZE event.
  // Enter once on will-* and leave once on the terminal moved/resized event.
  let nativeInteraction=false;
  const setNativeInteraction=(busy)=>{
    busy=!!busy;if(nativeInteraction===busy||!mainWindow||mainWindow.isDestroyed())return;nativeInteraction=busy;
    try{mainWindow.webContents.executeJavaScript(`window.aramRuntimePerformanceV01568?.setNativeInteraction(${busy?'true':'false'}); true`,false).catch(()=>{})}catch{}
  };
...
if(!app.requestSingleInstanceLock()){app.quit()}else if(isUpdateHandoff){
  ...
  app.whenReady().then(()=>{
    ...
    core.start();
    try{gradeCollector=riotGrade.createCollector(core,{app,intervalMs:5000});gradeCollector.start()}catch(e){console.error('[v0.16.3] Riot Grade collector init failed',e)}
