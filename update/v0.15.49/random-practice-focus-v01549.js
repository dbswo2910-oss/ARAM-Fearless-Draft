...
(()=>{
  ...
  function observe(){
    const targets=['#comboResults','#externalCheck','#poolInputs','#queueHint','#randomOurFive','#randomOurSummary','#randomEnemySummary','#randomRoles'];
    const mo=new MutationObserver(schedule);
    targets.map(s=>$(s)).filter(Boolean).forEach(el=>mo.observe(el,{childList:true,subtree:true,characterData:true,attributes:true,attributeFilter:['value','class']}));
