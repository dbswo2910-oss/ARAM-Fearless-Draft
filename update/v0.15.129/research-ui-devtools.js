 ...
 * Local-only personal research feature. Bundled by v0.15.129 update; not an official Rating/MMR feature.
 * It never starts history collection and never replaces production Match History / Player Profile owners.
 */
(()=>{
  const VERSION='aram-rating-ui-v015129';
  const FLAG_KEY='aram_rating_research_ui_enabled_v015129';
