  ...
  mainWindow.webContents.on('dom-ready',()=>{
    try{
      ...
      chain.then(()=>mainWindow.webContents.executeJavaScript('Boolean(window.__ARAM_LIVE_STRENGTH_V01513__) && Boolean(window.__ARAM_MATCH_LAB_FAVORITES_V01514__) && Boolean(window.__ARAM_ROLE_GRADE_V01513__) && Boolean(window.__ARAM_ROLE_GRADE_V01515__) && Boolean(window.__ARAM_MATCH_LAB_REPLAY_V01515__) && Boolean(window.__ARAM_MULTI_USER_ISOLATION_V01516__) && Boolean(window.__ARAM_MATCH_LAB_QUEUE_V01517__) && Boolean(window.__ARAM_DRAFT_BALANCE_V01517__) && Boolean(window.__ARAM_CATCH_RESILIENCE_V01540__) && Boolean(window.__ARAM_DRAFT_SIDE_ORDER_V01540__) && Boolean(window.__ARAM_BUILDER_CHAMPION_POOL_V01541__) && Boolean(window.__ARAM_DRAFT_LIVE_CONTEXT_V01542__) && Boolean(window.__ARAM_DRAFT_BALANCE_ALERTS_V01543__) && Boolean(window.__ARAM_DRAFT_LAYOUT_V01545__) && Boolean(window.__ARAM_DRAFT_RISK_BOARD_V01546__) && Boolean(window.__ARAM_DRAFT_JUDGMENT_TABS_V01547__) && Boolean(window.__ARAM_RANDOM_PRACTICE_FOCUS_V01549__) && Boolean(window.__ARAM_RANDOM_PICK_DENSITY_V01555__) && Boolean(window.__ARAM_RANDOM_INGAME_COACH_V01550__) && Boolean(window.__ARAM_RANDOM_INGAME_UX_V01551__) && Boolean(window.__ARAM_RANDOM_INGAME_UX_V01552__) && Boolean(window.__ARAM_RANDOM_INGAME_SHOP_V01553__) && Boolean(window.__ARAM_RANDOM_INGAME_SHOP_POLISH_V01554__) && Boolean(window.__ARAM_ROLE_METRIC_DETAIL_V01518__) && Boolean(window.__ARAM_CC_IMPACT_V01525__) && Boolean(window.__ARAM_MISSION_DEATH_FAIRNESS_V01529__) && Boolean(window.__ARAM_PLAYER_PROFILE_V01519__) && Boolean(window.__ARAM_LIVE_ITEM_MEMORY_V01520__) && Boolean(window.__ARAM_PLAYER_PROFILE_DIVERSITY_V01521__) && Boolean(window.__ARAM_ROLE_MASTERY_DRILLDOWN_V01522__) && Boolean(window.__ARAM_ROLE_PROFILE_CONTEXT_V01523__) && Boolean(window.__ARAM_ROLE_PROFILE_SPECIALIZED_V01530__) && Boolean(window.__ARAM_PROFILE_UX_V01537__) && Boolean(window.__ARAM_IN_APP_UPDATER_UI_V01523__) && Boolean(window.__ARAM_TIME_POWER_V01527__) && Boolean(window.__ARAM_RIOT_GRADE_V01528__) && Boolean(window.__ARAM_RIOT_GRADE_CALIBRATION_HISTORY_V01532__) && Boolean(window.__ARAM_RIOT_GRADE_AUTOSNAPSHOT_V01533__) && Boolean(window.__ARAM_COMMUNITY_CALIBRATION_V01534__) && Boolean(window.__ARAM_BRAND_HEADER_V01538__) && Boolean(window.__ARAM_INPUT_INTERACTION_STABILITY_V01539__)',false))
        .then(ok=>{if(!ok)console.error('[v0.15.55] runtime patch marker missing')})
        .catch(e=>console.error('[v0.15.55] runtime patch inject failed',e));
    }catch(e){console.error('[v0.15.55] runtime patch read failed',e)}
  });
...
if(!app.requestSingleInstanceLock()){app.quit()}else if(isUpdateHandoff){
  ...
  app.whenReady().then(()=>{
    ...
    core.start();
    try{gradeCollector=riotGrade.createCollector(core,{app,intervalMs:5000});gradeCollector.start()}catch(e){console.error('[v0.15.55] Riot Grade collector init failed',e)}
