...
(()=>{
  ...
  function start(){
    ...
    ensureStyles();sync();
    // v0.15.72: no independent observer/document listener. The single Random Practice
    // coordinator calls refresh after base renders and coalesced user interaction.
