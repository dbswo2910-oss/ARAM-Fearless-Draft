...
const scriptsNew="'runtime-random-practice-v01572.js','runtime-performance-v01568.js','runtime-live-autosync-v01571.js','live-strength-v01513.js'";
const readyOld='Boolean(window.__ARAM_RUNTIME_PERFORMANCE_V01568__) && Boolean(window.__ARAM_LIVE_STRENGTH_V01513__)';
const readyNew='Boolean(window.__ARAM_RANDOM_PRACTICE_RUNTIME_V01572__) && Boolean(window.__ARAM_RUNTIME_PERFORMANCE_V01568__) && Boolean(window.__ARAM_LIVE_AUTOSYNC_RUNTIME_V01571__) && Boolean(window.__ARAM_LIVE_STRENGTH_V01513__)';
...
const restoreNew="chain.then(()=>mainWindow.webContents.executeJavaScript('window.aramRandomPracticeRuntimeV01572?.finishBootstrap?.(); true',false)).then(()=>mainWindow.webContents.executeJavaScript('window.aramRuntimePerformanceV01568?.restoreTimerHook?.(); true',false))";
for(const needle of [scriptsOld,readyOld,executeOld,restoreOld,"const VERSION='0.15.70'"]){if(!src.includes(needle))throw new Error('v0.15.72 base main contract mismatch: '+needle.slice(0,80))}
