...
if(!fs.existsSync(basePath))throw new Error('v0.16.2 preload successor base missing');
const src=fs.readFileSync(basePath,'utf8');
const patched=patchPreloadSource(src);
if(!patched.changed&&!patched.alreadyPatched)throw new Error('v0.16.2 preload diagnostics hook was not applied');
