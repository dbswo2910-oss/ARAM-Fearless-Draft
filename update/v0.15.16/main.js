  ...
  mainWindow.webContents.on('dom-ready',()=>{
    try{
      ...
      mainWindow.webContents.executeJavaScript(liveCode,false)
        ...
        .then(ok=>{if(!ok)console.error('[v0.15.16] runtime patch marker missing')})
        .catch(e=>console.error('[v0.15.16] runtime patch inject failed',e));
    }catch(e){console.error('[v0.15.16] runtime patch read failed',e)}
  });
