  ...
  mainWindow.webContents.on('dom-ready',()=>{
    try{
      ...
      mainWindow.webContents.executeJavaScript(liveCode,false)
        ...
        .then(()=>mainWindow.webContents.executeJavaScript('Boolean(window.__ARAM_LIVE_STRENGTH_V01513__) && Boolean(window.__ARAM_MATCH_LAB_FAVORITES_V01514__) && Boolean(window.__ARAM_ROLE_GRADE_V01513__) && Boolean(window.__ARAM_ROLE_GRADE_V01515__) && Boolean(window.__ARAM_MATCH_LAB_REPLAY_V01515__) && Boolean(window.__ARAM_MULTI_USER_ISOLATION_V01516__) && Boolean(window.__ARAM_MATCH_LAB_QUEUE_V01517__) && Boolean(window.__ARAM_DRAFT_BALANCE_V01517__) && Boolean(window.__ARAM_ROLE_METRIC_DETAIL_V01518__) && Boolean(window.__ARAM_PLAYER_PROFILE_V01519__) && Boolean(window.__ARAM_LIVE_ITEM_MEMORY_V01520__)',false))
        .then(ok=>{if(!ok)console.error('[v0.15.20] runtime patch marker missing')})
        .catch(e=>console.error('[v0.15.20] runtime patch inject failed',e));
    }catch(e){console.error('[v0.15.20] runtime patch read failed',e)}
  });
